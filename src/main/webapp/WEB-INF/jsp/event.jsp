	          ...
	          <div class="col-lg-6 d-flex">
	            <form action="" class="bg-light p-5 contact-form" method="post">
	             <div class="form-group">
	              ...
	              <div class="form-group">
	                <input type="text" class="form-control" placeholder="Date and Time: dd/MM/yyyy" name="eventTime">
	              </div>
	              <div class="form-group">
	                <input type="text" class="form-control" placeholder="Total Amount" name="totalAmount">
	              </div>
	              <div class="form-group">
	                <input type="submit" value="Add Event" class="btn btn-primary py-3 px-5">
	              </div>
	            </form>
